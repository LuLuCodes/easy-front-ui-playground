...
function toggleDark() {
  ...
  cls.toggle('dark')
  localStorage.setItem('easy-front-ui-playground-prefer-dark', String(cls.contains('dark')))
}
</script>
...
<template>
  <nav>
    <h1>
      ...
      <span>Easy Front UI Playground</span>
    </h1>
    <div class="links">
      ...
      <button title="View on GitHub" class="github">
        <a href="https://github.com/LuLuCodes/easy-front-vite" target="_blank">
          <GitHub />
        </a>
      </button>
    </div>
